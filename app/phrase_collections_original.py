    ...
    def initialise_lookup(self):
        ...
        lookup = {
            'pp': PhraseCollection([Phrase([Note(69, 3), Note(69, 1)]),
                                    Phrase([Note(62, 3), Note(61, 1)]),
                                    Phrase([Note(53, 3), Note(52, 1)]),
                                    Phrase([Note(45, 3), Note(45, 1)])]),
            ...
            'ff': PhraseCollection([Phrase([Note(62, 1/4, 'accent'), Note(65, 1/4, 'stac'), Note(63, 1/4, 'stac'), Note(62, 1/4, 'stac'),
                                    ...
                                    Phrase([Note(62, 1/4, 'accent'), Note(65, 1/4, 'stac'), Note(63, 1/4, 'stac'), Note(62, 1/4, 'stac'),
                                            Note(70, 1/4, 'accent'), Note(74, 1/4, 'stac'), Note(72, 1/4, 'stac'), Note(70, 1/4, 'stac'),
                                            Note(74, 1/4, 'accent'), Note(77, 1/4, 'stac'), Note(75, 1/4, 'stac'), Note(74, 1/4, 'stac'),
                                            Note(70, 1/4, 'accent'), Note(74, 1/4, 'stac'), Note(72, 1/4, 'stac'), Note(70, 1/4, 'stac')]),
                                    Phrase([Note(50, 1/4, 'accent'), Note(53, 1/4, 'stac'), Note(51, 1/4, 'stac'), Note(50, 1/4, 'stac'),
                                            ...
                                            Note(58, 1/4, 'accent'), Note(62, 1/4, 'stac'), Note(60, 1/4, 'stac'), Note(58, 1/4, 'stac')]),
                                    Phrase([Note(38, 1/4, 'accent'), Note(41, 1/4, 'stac'), Note(39, 1/4, 'stac'), Note(38, 1/4, 'stac'),
